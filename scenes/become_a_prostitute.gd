...
#	SaveManager.save.visited_activities["prostitution"] = true
	...
	elif SaveManager.save.visited_activities["prostitution"] and \
	not SaveManager.save.vesper["sexual"]:
		dialogue_label.jump_to(21)

func _process(delta):
	if dialogue_label.message_id == 7:
		scene_bg.texture = load("res://assets/prostitution_storyboard/become_prostitute/becoming_prostitute_2.png")
	...
	if dialogue_label.message_id == 14:
		scene_bg.texture = load("res://assets/prostitution_storyboard/become_prostitute/becoming_prostitute_3.png")
	...
	if dialogue_label.message_id == 18:
		scene_bg.texture = load("res://assets/prostitution_storyboard/become_prostitute/becoming_prostitute_6.png")
	...
	if dialogue_label.message_id == 20 or dialogue_label.message_id == 32:
		scene_finished = true
